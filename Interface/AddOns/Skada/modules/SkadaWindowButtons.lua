...
function mod:OnEnable()
	...
	for _,window in ipairs(Skada:GetWindows()) do
		...
		if not window.bargroup.resetbutton then
			...
			window.bargroup.resetbutton:SetNormalTexture("Interface\\Addons\\Skada\\media\\statusbar\\icon-reset")
			window.bargroup.resetbutton:SetHighlightTexture("Interface\\Addons\\Skada\\media\\statusbar\\icon-reset", 1)
