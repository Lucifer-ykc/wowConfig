...
nodes["Darkshore"] = {
	...
	{ coord = 39763269, npcId = 149658, questId = { 54892 }, icon = "skull_grey", group = "rare_darkshore", label = _L["Shadowclaw"], loot = { { itemId = 166437, itemType = itemTypeMount, mountId = 1205 } }, note = _L["Horde only"], faction = "Horde" },
