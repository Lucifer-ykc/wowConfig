...
if crPlayersFrames==nil then
  ...
  crButtonStop:Hide()
    ...
    crCastBar2:SetColorTexture(0, 1, 0, 0.7)
    ...
    crCastBar3:SetColorTexture(0, 0, 1, 0.8)
    ...
    crHPBar4:SetColorTexture(0, 0, 1, 0.8)
    ...
    crRaidHPBar4:SetColorTexture(0, 0, 1, 0.4)
  ...
  if crsaveddata and crsaveddata[1] then
    ...
    crCastBarBoss13:SetColorTexture(0, 0, 1, 0.8)
  ...
  while (m<=50) do
    ...
    if deathrun==0 and crsaveddata[crPlayingCombatID] and crsaveddata[crPlayingCombatID].death and #crsaveddata[crPlayingCombatID].death>0 then
      for i=1,#crsaveddata[crPlayingCombatID].death do
        ...
        crTimeLineButtonColor[m]:SetColorTexture(1, 0, 0, 1)
