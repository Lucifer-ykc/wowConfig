      ...
      for j=1,25 do
        if crsaveddata[nr].events[ev].p[j] and j<=25 then
          ...
          if j==crPlayersActive[1] or j==crPlayersActive[2] then
            ...
            crPlayersFramesColor[j]:SetColorTexture(0, 1, 0, 1)
          elseif ev==1 then
            if crRangeCheckRaidActive and crRangeCheckRaidTable[j] then
              crPlayersFramesColor[j]:SetColorTexture(1, 0, 0, 1)
            else
              crPlayersFramesColor[j]:SetColorTexture(crClassColors[crsaveddata[nr].players[j].class].r, crClassColors[crsaveddata[nr].players[j].class].g, crClassColors[crsaveddata[nr].players[j].class].b, 1)
            end
          end
          ...
          if ev==1 then
            ...
            if #crsaveddata>0 then
              if crPlayersActive[1]~=crPlayersActive[2] then
                if crRangeCheckRaidActive and crRangeCheckRaidTable[crPlayersActive[1]] then
                  crPlayersFramesColor[crPlayersActive[1]]:SetColorTexture(1, 0, 0, 1)
                else
                  crPlayersFramesColor[crPlayersActive[1]]:SetColorTexture(crClassColors[crsaveddata[nr].players[crPlayersActive[1]].class].r, crClassColors[crsaveddata[nr].players[crPlayersActive[1]].class].g, crClassColors[crsaveddata[nr].players[crPlayersActive[1]].class].b, 1)
                end
                crPlayersButtonsColor[crPlayersActive[1]]:SetColorTexture(crClassColors[crsaveddata[nr].players[crPlayersActive[1]].class].r, crClassColors[crsaveddata[nr].players[crPlayersActive[1]].class].g, crClassColors[crsaveddata[nr].players[crPlayersActive[1]].class].b, 1)
              ...
              crPlayersButtonsColor[j]:SetColorTexture(crClassColors[crsaveddata[nr].players[j].class].r, crClassColors[crsaveddata[nr].players[j].class].g, crClassColors[crsaveddata[nr].players[j].class].b, 0.2)
              crPlayersFramesColor[j]:SetColorTexture(0, 1, 0, 1)
            ...
            crPlayersButtonsColor[j]:SetColorTexture(crClassColors[crsaveddata[nr].players[j].class].r, crClassColors[crsaveddata[nr].players[j].class].g, crClassColors[crsaveddata[nr].players[j].class].b, alphabg)
        ...
        for m=1,25 do
          if crRangeCheckRaidTable[m] then
            if crPlayersActive[1]==m or crPlayersActive[2]==m then
              crPlayersFramesColor[m]:SetColorTexture(0, 1, 0, 1)
            else
              crPlayersFramesColor[m]:SetColorTexture(1, 0, 0, 1)
            end
          end
        end
      end
...
if crsaveddata and crsaveddata[crPlayingCombatID] then
  ...
  if crsaveddata[crPlayingCombatID].events[crPlayingCombatEvent].p[crPlayersActive[#crPlayersActive]]==nil or (crsaveddata[crPlayingCombatID].events[crPlayingCombatEvent+1] and crsaveddata[crPlayingCombatID].events[crPlayingCombatEvent+1].p[crPlayersActive[#crPlayersActive]]==nil) then
   ...
   while i<=#crsaveddata[crPlayingCombatID].events[crPlayingCombatEvent].p do
      if crsaveddata[crPlayingCombatID].events[crPlayingCombatEvent].p[i] and (crsaveddata[crPlayingCombatID].events[crPlayingCombatEvent+1]==nil or (crsaveddata[crPlayingCombatID].events[crPlayingCombatEvent+1].p)) then
              crPlayersButtonsColor[crPlayersActive[#crPlayersActive]]:SetColorTexture(crClassColors[crsaveddata[crPlayingCombatID].players[crPlayersActive[#crPlayersActive]].class].r, crClassColors[crsaveddata[crPlayingCombatID].players[crPlayersActive[#crPlayersActive]].class].g, crClassColors[crsaveddata[crPlayingCombatID].players[crPlayersActive[#crPlayersActive]].class].b, 1)
              crPlayersFramesColor[crPlayersActive[#crPlayersActive]]:SetColorTexture(crClassColors[crsaveddata[crPlayingCombatID].players[crPlayersActive[#crPlayersActive]].class].r, crClassColors[crsaveddata[crPlayingCombatID].players[crPlayersActive[#crPlayersActive]].class].g, crClassColors[crsaveddata[crPlayingCombatID].players[crPlayersActive[#crPlayersActive]].class].b, 1)
              crPlayersFramesNames[crPlayersActive[#crPlayersActive]]:Hide()
              table.remove(crPlayersActive,1)
              table.insert(crPlayersActive,i)
              table.wipe(crInstanceSpellsShow)
              crPlayersButtonsColor[i]:SetColorTexture(crClassColors[crsaveddata[crPlayingCombatID].players[i].class].r, crClassColors[crsaveddata[crPlayingCombatID].players[i].class].g, crClassColors[crsaveddata[crPlayingCombatID].players[i].class].b, 0.2)
              crPlayersFramesColor[i]:SetColorTexture(0, 1, 0, 1)
              crPlayersFramesNames[i]:Show()
              i=100
              --рендж чек между 2 игроков
              crGetRangeBetweenPlayers(nil,nil,0)
  ...
  if changedEvent==1 then
    ...
    if hp1/hp2<=0.3 then
      crHPBar2:SetColorTexture(1, 0, 0, 0.7)
    else
      crHPBar2:SetColorTexture(0, 1, 0, 0.7)
    end
    ...
    if totalhp1/totalhp2<=0.3 then
      crRaidHPBar2:SetColorTexture(1, 0, 0, 0.7)
    else
      crRaidHPBar2:SetColorTexture(0, 1, 0, 0.7)
    end
...
if changedEvent==1 then
  ...
  if i<=4 then
    ...
    crHPBarBoss12[i]:SetColorTexture(0, 1, 0, 0.7)
...
{r=0.64, g=0.19,b=0.79,h="|CFFA330C9",c="demonhunter"}
}
