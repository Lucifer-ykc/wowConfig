...
pspullactiv=1
C_ChatInfo.SendAddonMessage("PSaddon", "10"..timertopull, "RAID")
...
if(DBM)then
		...
		C_ChatInfo.SendAddonMessage("D4", "PT\t" .. pstime .. "\t" .. curZoneID, "RAID")

else
		--C_ChatInfo.SendAddonMessage("DBMv4-Pizza", ("%s\t%s"):format(pstime, pstext), "RAID")
...
--BIGWIGS
C_ChatInfo.SendAddonMessage("BigWigs", "T:BWPull "..pstime, "RAID")
...
--KLE
--C_ChatInfo.SendAddonMessage("KLE", "^1^SAlertsRaidBar^N"..pstime.."^S~`"..pstext.."^^", "RAID")
...
if pstime>60 then
  C_ChatInfo.SendAddonMessage("PSaddon", "20"..pstext.."^"..pstime, "RAID")
end
